...
export class StandingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if (input === 'PRESS space') this.player.setState(states.JUMPING_LEFT);
    }
}
...
export class StandingRight extends State {
    ...
    handleInput(input) {
        ...
        else if (input === 'PRESS space') this.player.setState(states.JUMPING_RIGHT)
    }
}
...
export class SittingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if (input === 'PRESS jump') this.player.setState(states.JUMPING_LEFT);
    }
}
...
export class SittingRight extends State {
    ...
    handleInput(input) {
        ...
        else if (input === 'PRESS jump') this.player.setState(states.JUMPING_RIGHT);
    }
}
